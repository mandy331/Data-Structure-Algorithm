...
class MyHashSet:
    ...
    def add(self, key):
        ...
        cur_box = self.data[HashKey%self.capacity] 
        if cur_box == None: 
            cur_box = LinkedList() 
            cur_box.addAtHead(HashKey) 
        else: 
            cur_box.addAtTail(HashKey) 
        self.data[HashKey%self.capacity] = cur_box 
    ...
    def remove(self, key):
        ...
        if cur_box == None: 
            ...
            duplicated = cur_box.search_index(HashKey) 
